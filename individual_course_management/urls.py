...
from .views import Dashboard, Chapters, Contents, Templates, ShortQuizComplited, QuizComplited, TextBookComplited
...
urlpatterns = [
    ...
    path("textBookComplited/", TextBookComplited.as_view(), name="textBookComplited"),
    path("shortQuizCompleted/", ShortQuizComplited.as_view(), name="shortQuizCompleted"),
    path("quizComplited/", QuizComplited.as_view(), name="quizComplited"),
]